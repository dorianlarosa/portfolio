        ...
        <div class="container-form">
            ...
            <form id="form-contact" class="form page-1" action="">
                ...
                <div class="page-form page-form__1">
                    ...
                    <div class="page-form__bar-bottom">
                ...
                <div class="page-form page-form__2">
                    <div class="page-form__content">
                        <p class="page-form__title">
                    ...
                    <div class="page-form__bar-bottom"><span class="page-status">
                            2/4
                        </span>
                        <div class="previous-page btn-previous-page-form btn-previous-page-form__page-2 click">
                ...
                <div class="page-form page-form__3">
                    <div class="page-form__content">
                        <p class="page-form__title">
                    ...
                    <div class="page-form__bar-bottom">
                        ...
                        <div class="previous-page btn-previous-page-form btn-previous-page-form__page-3 click">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                            </svg>
                            <span>Précedent</span>
                ...
                <div class="page-form page-form__4">
                    <div class="page-form__content">
                        <p class="page-form__title">
                    ...
                    <div class="page-form__bar-bottom">
                        ...
                        <div class="previous-page btn-previous-page-form btn-previous-page-form__page-4 click">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                            </svg>
                            <span>Précedent</span>
