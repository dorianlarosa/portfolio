...
<section id="a-propos-section" class="container">
    ...
    <div class="row element element-1">
        ...
        <div class="col-12 col-md-6 order-md-1 col-element">
        ...
        <div class="col-12 col-md-6 col-element">
        ...
        <div class="content content--full content--alternate">
            <div class="item-projet">
                <div class="item-imgwrap">
                    <img class="item-img" src="<?= get_template_directory_uri() ?>/images/projets/vcn.jpg)" alt="" srcset="">
            ...
            <div class="item-projet">
                <div class="item-imgwrap">
                    <img class="item-img" src="<?= get_template_directory_uri() ?>/images/projets/soundpods.jpg)" alt="" srcset="">
                </div>
            ...
            <div class="item-projet">
                <div class="item-imgwrap">
                    <img class="item-img" src="<?= get_template_directory_uri() ?>/images/projets/egs.jpg)" alt="" srcset="">
                </div>
            ...
            <div class="item-projet">
                <div class="item-imgwrap">
                    <img class="item-img" src="<?= get_template_directory_uri() ?>/images/projets/real.jpg)" alt="" srcset="">
                </div>
            ...
            <div class="item-projet">
                <div class="item-imgwrap">
                    <img class="item-img" src="<?= get_template_directory_uri() ?>/images/projets/bornes.jpg)" alt="" srcset="">
                </div>
